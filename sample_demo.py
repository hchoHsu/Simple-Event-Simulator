...
raw_images = ['173_462_474_s_41171687.png',
            '174_462_474_s_41211687.png',
...
evt_images = natsorted(glob.glob(os.path.join(folder_path, 'ev_*.png')))
...
if __name__ == '__main__':
    ...
    for i in range(len(evt_images)):
        ...
        frame[:HEIGHT, WIDTH:WIDTH*2, :3] = cv.imread(evt_images[i])
